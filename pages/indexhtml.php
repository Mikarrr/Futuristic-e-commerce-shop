...
<body>
    ...
    <div class="container wrapper">
        ...
        <header class="header nav-links">
            <a href="../pages/registerhtml.php" class="header__sign-in animate__animated animate__fadeInLeft">Sign
                in</a>
        ...
        <footer>
            <div class="footer-container animate__animated animate__fadeInUp">
