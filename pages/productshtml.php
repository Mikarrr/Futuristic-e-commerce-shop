...
<body>
    ...
    <header class="header nav-links">
        ...
        <a href="../pages/registerhtml.php" class="header__sign-in animate__animated animate__fadeInLeft">Sign in</a>
        ...
        <div class="product">
            <form method="post" action="">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, amet ipsa ab assumenda magni
                    mollitia alias non sapiente nihil, earum quos et necessitatibus tempore optio, vitae expedita odio
                    sequi quo!</p>

                <input class="add_button" type="submit" name="add_to_cart" value="Add to Cart">
                <input class="quantity_input" type="number" id="quantity_<?php echo $product['id']; ?>" name="quantity"
                    value="1" min="1">
            </form>
        </div>
